...
static const char num_skip_frame_message[] = "Optional. Number of frames to be skipped per inference.";
static const char outfile_message[] = "Required. Output file.";
static const char save_images_message[] ="Required. Output image path.";
...
DEFINE_int32(nskip, 0, num_skip_frame_message);
DEFINE_string(outfilepath, "./tmp.txt", outfile_message);
DEFINE_string(save_image_path, "", save_images_message);
...
static void showUsage() {
    ...
    std::cout << "    -nskip                    " << num_skip_frame_message << std::endl;
    std::cout << "    -outfilepath <path> " << outfile_message << std::endl;
    std::cout << "    -save_image_path <path> " << save_images_message << std::endl;
}
